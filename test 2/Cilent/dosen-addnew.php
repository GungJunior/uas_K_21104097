...
<form id="dosenbaru">
  ...
  <div class="mb-3">
    <label for="mengampuh" class="form-label">Mengampuh MataKuliah</label>
    <input type="text" class="form-control" id="txmengampuh">
    <div id="mengampuhHelp" class="form-text">Isikan Mengampuh MataKuliah</div>
  </div>
